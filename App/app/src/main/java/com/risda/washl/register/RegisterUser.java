...
public class RegisterUser extends AppCompatActivity {
    Button regis;
    EditText username, email, password, telp, etOtp;

    private FirebaseAuth mAuth;
    private String verificationId;
    private Button verifyOTPBtn, generateOTPBtn;

    String SITE_KEY = "6Ld072MdAAAAAEBvGhZhJ1HMrw1qtHCBK_X_5A8l";
    String SECRET_KEY = "6Ld072MdAAAAAM9iCqhsxRAuQM4-QQvW7Y9_-6Ui";
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = findViewById(R.id.regisUser);
        email = findViewById(R.id.regisEmailUser);
        password = findViewById(R.id.regisPassUser);
        telp = findViewById(R.id.regisTelpUser);

        etOtp = findViewById(R.id.etOTP);
        generateOTPBtn = findViewById(R.id.btnOTP);

        regis = findViewById(R.id.btnRegisterUser);
        ...
        regis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(RegisterUser.this, "Data Harus terisi", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(RegisterUser.this, LoginUser.class));
                }
                else if (password.getText().toString().isEmpty() || password.getText().toString().length() < 8 || !password.getText().toString().matches("[a-z,A-Z,0-9]*"))
                {
                    Toast.makeText(RegisterUser.this, "Password Tidak Boleh Kurang Dari 8", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(RegisterUser.this, LoginUser.class)); }
                else if (email.getText().toString().isEmpty() || !email.getText().toString().contains("@gmail.com"))
                {
                    Toast.makeText(RegisterUser.this, "Alamat Email Tidak Valid", Toast.LENGTH_SHORT).show();
                }
                else if (TextUtils.isEmpty(etOtp.getText().toString()))
                {
                    // if the OTP text field is empty display
                    // a message to user to enter OTP
                    Toast.makeText(RegisterUser.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                } else {
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(telp.getText().toString())) {
                    ...
                    String phone = "+62" + telp.getText().toString();
        ...
        registerResponseCall.enqueue(new Callback<RegisterResponse>() {
            ...
            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    Intent h = new Intent(RegisterUser.this, LoginUser.class);
                    startActivity(h);
                    finish();

                } else {
                    Toast.makeText(RegisterUser.this, "Register Gagal", Toast.LENGTH_SHORT).show();
                }
            }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(RegisterUser.this, HomepageUser.class);
                            startActivity(i);
                            finish();
                        } else {
                ...
                .addOnFailureListener(this, new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        if (e instanceof ApiException) {
                            ...
                            Toast.makeText(RegisterUser.this, "Error found is : " + e, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("success")) {
                                ...
                                Toast.makeText(RegisterUser.this, "User verified with reCAPTCHA", Toast.LENGTH_SHORT).show();
                            } else {
